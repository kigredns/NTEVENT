...
local Library = {
    Colors = {
        ...
        CheckboxChecked = Color3.fromRGB(207, 34, 14);
        ...
        Slider = Color3.fromRGB(207, 34, 14);
        ...
        Text = Color3.fromRGB(207, 34, 14);
        PlaceholderText = Color3.fromRGB(207, 34, 14);
    };
...
function libraryv3:CreateWindow(name)
    ...
    TextLabel.BackgroundColor3 = Color3.new(0.8118, 0.1333, 0.0549)
    TextLabel.BackgroundTransparency = 1
    TextLabel.Size = UDim2.new(0, 190, 0, 34)
    TextLabel.Font = Enum.Font.Code
    TextLabel.Text = name
    TextLabel.TextColor3 = Color3.new(0.8118, 0.1333, 0.0549)
    ...
    TextLabel_2.TextColor3 = Color3.new(0.8118, 0.1333, 0.0549)
    ...
    function wowlib:Button(name, action)
        ...
        TextButton.BackgroundColor3 = Color3.new(0.8118, 0.1333, 0.0549)
        TextButton.BackgroundTransparency = 1
        TextButton.BorderColor3 = Color3.new(0.8118, 0.1333, 0.0549)
        ...
        TextButton_Roundify_2px.BackgroundColor3 = Color3.new(0.8118, 0.1333, 0.0549)
        ...
        TextButton_Roundify_2px.ImageColor3 = Color3.new(0.8118, 0.1333, 0.0549)
        ...
        TextLabel_3.BackgroundColor3 = Color3.new(0.8118, 0.1333, 0.0549)
    ...
    function wowlib:Box(name, callback)
        ...
        TextBox.Text = ""
        TextBox.TextColor3 = Color3.new(0.8118, 0.1333, 0.0549)
        TextBox.TextSize = 14
...
Frame_5.BackgroundColor3 = Color3.new(0.8118, 0.1333, 0.0549)
...
TextButton_Roundify_2px_2.BackgroundColor3 = Color3.new(0.8118, 0.1333, 0.0549)
...
TextLabel_4.BackgroundColor3 = Color3.new(0.8118, 0.1333, 0.0549)
TextLabel_4.BackgroundTransparency = 1
TextLabel_4.Size = UDim2.new(0, 145, 0, 27)
TextLabel_4.Font = Enum.Font.GothamSemibold
TextLabel_4.Text = " "..name
TextLabel_4.TextColor3 = Color3.new(0.8118, 0.1333, 0.0549)
...
TextButton_2.MouseButton1Down:connect(function()
    ...
    if Enabled then
        TextButton_Roundify_2px_2.ImageColor3 = Color3.fromRGB(207, 34, 14)
